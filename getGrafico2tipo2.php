<?php
	...
	$query2="SELECT ore,data FROM programmazione_grafico2tipo2  WHERE commessa=".$_SESSION['id_commessa']." AND ponte IN ('".$inPonti."') AND nomeDitta IN ('".$inDitte."') AND anno IN ('".$inAnni."') AND mese IN ('".$inMesi."')";	
	$result2=sqlsrv_query($conn,$query2);
	if($result2==FALSE)
	{
		echo "<br><br>Errore esecuzione query<br>Query: ".$query2."<br>Errore: ";
