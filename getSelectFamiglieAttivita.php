<?php
	...
	$queryRighe="SELECT distinct [Famiglia] FROM [tip cab] WHERE [Famiglia] NOT IN (SELECT DISTINCT famiglia FROM programmazione_tipologie_attivita WHERE codice_attivita =$codice_attivita AND commessa=".$_SESSION['id_commessa'].") ORDER BY [Famiglia] DESC";
