<?php
	...
	$query2="SELECT SUM(ore) AS ore,mese FROM programmazione_grafico1  WHERE commessa=".$_SESSION['id_commessa']." AND ponte IN ('".$inPonti."') AND nome IN ('".$inDitte."') AND anno IN ('".$inAnni."') GROUP BY mese";	
	$result2=sqlsrv_query($conn,$query2);
	if($result2==FALSE)
	{
		echo "<br><br>Errore esecuzione query<br>Query: ".$query2."<br>Errore: ";
